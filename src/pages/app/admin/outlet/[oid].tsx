...
const OutletDetail: NextPageWithLayout = () => {
  ...
  const updateOutlet = trpc.outlet.updateById.useMutation({
    onSuccess: () => {
  ...
  return (
    <form onSubmit={submitHandler}>
      <div className="flex items-center justify-between">
        ...
        <button className="btn-secondary rounded">Simpan Data</button>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`input ${errors.address ? "!border-red-500" : null} `}
            />
            {errors.address && (
              <span className="text-xs font-medium text-red-500">
                This field is required
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`input ${errors.contact ? "!border-red-500" : null} `}
            />
            {errors.contact && (
              <span className="text-xs font-medium text-red-500">
                This field is required
